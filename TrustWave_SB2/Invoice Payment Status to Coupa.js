...
function scheduled(type) {
	...
	try {
		...
		nlapiSendEmail(-5, nlapiGetContext().getSetting('SCRIPT',
				'custscript_coupa_send_inv_pay_email'), nlapiGetContext()
				.getSetting('SCRIPT', 'custscript_coupa_send_inv_pmt_acctname')
	...
	filters[3] = new nlobjSearchFilter('datecreated', 'applyingtransaction', 'onOrAfter',
				'daysAgo1');
