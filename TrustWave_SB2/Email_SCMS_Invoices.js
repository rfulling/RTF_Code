/* 
 * copy of email searhc for the smsm invoices 
 */
...
function scheduled(type){
	...
	*/
	...
	var results = nlapiSearchRecord('invoice', 'customsearch_ts_scsm_email_inv', null, null);
		...
		for (var k = 0; k < results.length; k++)
			{
				...
				{
					nlapiSendEmail(
						23779,23779,'Error Sending Email','Error Sending Email for 15th - SCMS. Please Enter To Email Address for Invoice: ' + tranid);
				}
