		...
		for (var k = 0; k < results.length; k++)
			{
				...
				if (!toEmail)
				{
					nlapiSendEmail(23779,23779,'Error Sending Email','Error Sending Email for 27th - FCP Monthly, Quarterly FCP. Please Enter To Email Address for Invoice: ' + tranid);
				}
				...
				//here add by RF to save a copy on the transaction
